...
struct TrainingView: View {
    ...
    var body: some View {
        ...
        .onChange(of: speechController.isRecording) { _, isRecording in
            isMicPulseVisible = isRecording
        }
        .onChange(of: speaker.isSpeaking) { wasSpeaking, isSpeaking in
    ...
    private var trainingSessionScreen: some View {
        VStack(spacing: 8) {
            ScreenHeaderCard(
                style: sectionStyle,
                title: "Trainieren",
    ...
    private var trainingSetupScreen: some View {
