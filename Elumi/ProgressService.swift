...
final class ProgressService {
    ...
    func record(session: LearningSession) -> SessionRewardOutcome {
        ...
        // **2026-08-08** — der frühere Schritt 4b („heutigen Tag fürs
        // Wochenziel buchen", `LearningGoalStore.recordPracticeToday()`)
        // ist entfallen: das Tagesziel liest jetzt direkt aus (5b)
        // `todayCorrectCount` mit — kein separater Buchungsaufruf mehr
        // nötig, keine zweite Zähler-Quelle.
